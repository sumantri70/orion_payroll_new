...
public class FilterLaporanPenggajian extends AppCompatActivity {
    ...
    protected void EventClass(){
        ...
        txtTglDari.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                hideSoftKeyboard(FilterLaporanPenggajian.this);
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(FilterLaporanPenggajian.this,
        ...
        txtPegawai.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                IdPegawaiTmp = 0;
                txtPegawai.setText("");
                Intent s = new Intent(FilterLaporanPenggajian.this, lov_pegawai.class);
                FilterLaporanPenggajian.this.startActivityForResult(s, RESULT_LOV);
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filter_laporan_penggajian);
        CreateView();
        InitClass();
        EventClass();
    }
